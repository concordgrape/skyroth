      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg p-8 md:p-12">
        ...
        <div className="mb-8">
          <p className="text-gray-700 leading-relaxed">
            Welcome to our privacy policy. We value your trust and are committed to protecting your privacy. This Privacy Policy is designed to help you understand how we collect, use, disclose, and safeguard your personal information when you use Dermi. By using Dermi, you agree to the practices described in this Privacy Policy.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p>Dermi allows users to input photos and data related to their skincare routines. This data will be stored on our platform.</p>
            </div>
